...
namespace WolfsonianBuilderModule
{
    /// <summary> Folder-level builder module for custom Wolfsonian processing </summary>
    ...
    {
        private const string archived_files_link = "http://resources.domain.edu/";
        private const string log_email_address = "your_email@domain.com";
        private const string SqlConnectionString = "data source=SERVERNAME;initial catalog=DBNAME;integrated security=Yes;";
        ...
        private string Get_Next_BibID(string BibIdStart)
        {
            ...
            using (SqlConnection sqlConnect = new SqlConnection(SqlConnectionString))
            {
                try
                {
                    sqlConnect.Open();
